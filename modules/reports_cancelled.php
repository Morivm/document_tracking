    ...
    <div class="app-content content">
        ...
        <script>
            ...
            $(function() {
                ...
                pageLocation("li_reports", "li_reports_cancelled", "Cancelled Documents");
                
                var returned_global_min = "";
                var returned_global_max = "";   
                var tbl_1               = "";
                var doc_status          = "CANCELLED";

                $('input[name="rs_text_1_2"]').val('');
                $('input[name="rs_text_1_2"]').attr("placeholder","Choose a Date Cancelled range");
