        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <form class="form form-horizontal" id="formdownloadform" action="recieve_transfer_download.php" method="post">
                    <input type="submit" class="btn btn-success" id="btn-donwloadAttach" value="Download Attachments">
                </form>
    ...
    <div class="app-content content">
        ...
        <script>
            ...
            $(function() {
                ...
                pageLocation("li_reports", "li_reports_approved", "Approved Documents");
                
                var returned_global_min = "";
                var returned_global_max = "";   
                var tbl_1               = "";
                var doc_status          = "APPROVED";

                $('input[name="rs_text_1_2"]').val('');
                $('input[name="rs_text_1_2"]').attr("placeholder","Choose a Date Approved range");
                ...
                $(`#tbl_1 tbody`).on( 'click', '.btn-export', function (e) {
                    e.preventDefault();
                    var data        = table.row( $(this).parents('tr') ).data();
                    var barcode     = data['row1'];

                    window.location.href = `../actions/act_excel_report_approved.php?barcode=${barcode}`;
                    // var view_detailed_rep = "";
