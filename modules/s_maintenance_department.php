    ...
    <div class="app-content content">
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title"><button class="btn btn-primary btn-actions" id="btn_create" name="btn_create" data-action="ADD"> <i class="las la-plus"></i> Add Department</button> </h4>
        ...
        <script>
            $(function(){
                ...
                pageLocation("li_mainte", "li_mainte_department", "Departments");
